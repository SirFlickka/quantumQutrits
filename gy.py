...
for angle in rotation_steps:
    for gate in ['rx', 'ry', 'rz']:
        gate_sequences.append([(gate, angle)])
...
for gate_sequence in gate_sequences:
    ...
    # Add results to dictionary, convert complex numbers to strings
    results[str(gate_sequence)] = [str(x) for x in statevector.tolist()]
